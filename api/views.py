...
def getFeed(request):
    ...
    for item in posts:
        ...
        post_data = { "post":{"postId":item.id,"user_liked_post":user_liked_post,"post_catalogue_count":post_catalogue_count,"products_count":post_products_count,"likes_count":post_likes_count,"views_count":post_views_count,"comments_count":post_comments_count,"title":item.title,"cover":item.post_cover,"is_video":item.video,"description":item.description,"brand_id":item.brand.id,"date":item.date,"catalogue":post_catalogue,"comments":comments_array},"brand":brand_object}
...
def getBrandPosts(request):
    ...
    for item in get_posts:
        ...
        post_data = {"postId":item.id,"user_liked_post":user_liked_post,"post_catalogue_count":post_catalogue_count,"products_count":post_products_count,"likes_count":post_likes_count,"views_count":post_views_count,"comments_count":post_comments_count,"title":item.title,"cover":item.post_cover,"is_video":item.video,"description":item.description,"brand_id":brand_id,"date":item.date,"catalogue":post_catalogue,"comments":comments_array}
        posts_array.append(post_data)
